...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/python-neutronclient-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12042&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/python-neutronclient-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `python-neutronclient` can be installed with:

```
conda install python-neutronclient
```

It is possible to list all of the versions of `python-neutronclient` available on your platform with:
