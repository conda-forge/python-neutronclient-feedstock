About python-neutronclient-feedstock
====================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/python-neutronclient-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/python-neutronclient-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add python-neutronclient
# for installing globally
pixi global install python-neutronclient
```
...
It is possible to list all of the versions of `python-neutronclient` available on your platform:
...
```
pixi search python-neutronclient --channel conda-forge
```
